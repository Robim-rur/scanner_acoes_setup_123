...
# ===============================
acoes_100 = ["RRRP3.SA","ALOS3.SA","ALPA4.SA","ABEV3.SA","ARZZ3.SA","ASAI3.SA","AZUL4.SA","B3SA3.SA","BBAS3.SA","BBDC3.SA",
...
bdrs_50 = ["AAPL34.SA","AMZO34.SA","GOGL34.SA","MSFT34.SA","TSLA34.SA","META34.SA","NFLX34.SA","NVDC34.SA","MELI34.SA","BABA34.SA",
...
etfs_fiis_24 = ["BOVA11.SA","IVVB11.SA","SMAL11.SA","HASH11.SA","GOLD11.SA","GARE11.SA","HGLG11.SA","XPLG11.SA","VILG11.SA",
"BRCO11.SA","BTLG11.SA","XPML11.SA","VISC11.SA","HSML11.SA","MALL11.SA","KNRI11.SA","JSRE11.SA","PVBI11.SA","HGRE11.SA",
"MXRF11.SA","KNCR11.SA","KNIP11.SA","CPTS11.SA","IRDM11.SA"]
...
def setup_123_inside(df_d, df_w):
    ...
    for i in range(-20, -2):
        ...
        if c2["Low"] < c1["Low"] and c3["Low"] > c2["Low"]:
            return {"Padrão":"123","Entrada":round(c3["High"],2),"Stop":round(c2["Low"],2)}

        if c3["High"] <= c2["High"] and c3["Low"] >= c2["Low"]:
            return {"Padrão":"Inside Bar","Entrada":round(c2["High"],2),"Stop":round(c2["Low"],2)}
...
def scan_lista(lista, tipo):
    ...
    for i, ativo in enumerate(lista):
        ...
        try:
            ...
            sinal = setup_123_inside(df_d, df_w)
